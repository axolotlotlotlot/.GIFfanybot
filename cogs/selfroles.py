...
class SelfRoles(commands.Cog):
    ...
    @commands.command()
    @commands.has_role('Mods')
    async def removerole(self, ctx, *roleNames):
        if not roleNames:
    ...
    @commands.command(alias='addme')
    async def giveme(self, ctx, rankName):
    ...
    @commands.has_role('Mods')
    async def giveyou(self, ctx, rankName):
        role: discord.Role
    ...
    @commands.command(alias='selfroles')
